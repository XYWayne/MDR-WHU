...
def get_model(num_users, num_items, layers = [20,10], reg_layers=[0,0]):
    ...
    MLP_Embedding_Item = Embedding(input_dim = num_items + 2, output_dim = layers[0]//2, name = 'item_embedding', embeddings_initializer = 'random_normal', embeddings_regularizer = l2(reg_layers[0]), input_length=1)  

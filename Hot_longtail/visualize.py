...
x_labels = ['10%', '20%', '30%', '40%', '50%', '60%'] # ', '40%', '50%', '60%', '70%', '80%', '90%', '100%'
ml_hr = [0.5436, 0.5801, 0.5940, 0.6086, 0.6248, 0.6415, 0.6520] 
ml_ndcg = [0.2978, 0.3204, 0.3310, 0.3477, 0.3517, 0.3708, 0.3788]

yelp_hr = [0.7245, 0.7263, 0.7343, 0.7377, 0.7382, 0.7473]
yelp_ndcg = [0.4362, 0.4402, 0.4445, 0.4497, 0.4544, 0.4579]
